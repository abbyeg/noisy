...
impl IndexMut<usize> for PermutationTable {
...
impl PermutationTable {
  /// Create a new table using the original Perlin integer order
  pub fn new() -> Self {
    let perms = vec![151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7,
...
mod tests {
  ...
  fn test_new_table() {
    ...
    assert_eq!(137, table[2]); // should be able to index into it
  }
}